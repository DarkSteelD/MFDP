...
/**
 * NIfTI Viewer component that integrates MRIcroWeb (or similar) for 3D visualization
 */
const NiftiViewer = ({ fileUrl, onLoad, onError }) => {
  ...
  const buildViewerUrl = () => {
    ...
    if (fileUrl) params.append('file', fileUrl);
    params.append('_ts', String(Date.now()));
    return `/nifti-viewer/index.html?${params.toString()}`;
  };
